...
4. Set up "push to deploy" at developers.google.com/console > Source Code > Releases > Create Pipeline pointing to the new repo. (GAE release pipelines are experimental as of 10/2014. The first time you may have to deploy traditionally through googleappengine launcher or such)
